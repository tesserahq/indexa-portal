<p align="center">
  ...
  <h2 align="center">Indexa Portal</h2>
  <p align="center">
    This will be the internal tool used to manage indexes and integrations with 3party services like Algolia.
  </p>
</p>
...
- **Manage search indexes** across internal products
- **Configure and monitor integrations** with 3party services
- **Expose tools to**:
  - Create and update indexes
  - Manage integration credentials
  - Review integration health and sync status
...
1. Build the image
   ...
   ```bash
   docker build -t indexa-portal .
   ```

2. Run the container

   ```bash
   docker run -p 3000:3000 indexa-portal:latest
   ```
