...
export default [
  ...
  layout('layouts/private.layouts.tsx', [
    ...
    route('reindex-jobs', 'routes/main/reindex-jobs/layout.tsx', [
      ...
      route(':reindexID', 'routes/main/reindex-jobs/detail/layout.tsx', [
    ...
    route('domain-services', 'routes/main/domain-services/layout.tsx', [
      ...
      route(':domainID/edit', 'routes/main/domain-services/edit.tsx'),
      route(':domainID', 'routes/main/domain-services/detail/layout.tsx', [
